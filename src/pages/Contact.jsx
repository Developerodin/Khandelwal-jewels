...
import { IonContent, IonHeader, IonPage, IonTitle, IonToolbar, IonCard, IonCardContent, IonIcon,IonBackButton,IonButtons } from '@ionic/react';
import { mailOutline, callOutline, logoWhatsapp, globeOutline, locationOutline,arrowBackSharp } from 'ionicons/icons';
import './Contact.css';
...
const Contact = () => {
  return (
    <IonPage>
      ...
      <IonButtons slot="">
      <IonBackButton defaultHref="/" text="" className="back-button" icon={arrowBackSharp} />
    </IonButtons>
